...
327 modules in 33 packages, 171 JSON API routes, 31 UI modules, 115 test files; capabilities in CAPABILITIES.yaml.
...
- **capabilities** — the capability registry, resolver, acquisition and health (20 modules, 5423 lines)
...
- **experts** — Optional stronger intelligence, recruited on Jarvis' terms. (8 modules, 2122 lines)
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (41 modules, 23869 lines)
