...
330 modules in 33 packages, 171 JSON API routes, 33 UI modules, 122 test files; capabilities in CAPABILITIES.yaml.
...
- **gateway** — The ZEUS model gateway: one boundary between ZEUS and every model provider. (16 modules, 4847 lines)
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (43 modules, 24604 lines)
