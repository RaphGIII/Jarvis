...
334 modules in 33 packages, 179 JSON API routes, 35 UI modules, 130 test files; capabilities in CAPABILITIES.yaml.
...
- **owner** — The owner's domain: what ZEUS is, how it behaves, what it may spend. (5 modules, 991 lines)
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (43 modules, 25310 lines)
