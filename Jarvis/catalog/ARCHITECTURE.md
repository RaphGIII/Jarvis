...
328 modules in 33 packages, 171 JSON API routes, 31 UI modules, 120 test files; capabilities in CAPABILITIES.yaml.
...
- **gateway** — The ZEUS model gateway: one boundary between ZEUS and every model provider. (15 modules, 4090 lines)
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (42 modules, 24425 lines)
