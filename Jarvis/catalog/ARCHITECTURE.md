...
333 modules in 33 packages, 179 JSON API routes, 35 UI modules, 128 test files; capabilities in CAPABILITIES.yaml.
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (43 modules, 25132 lines)
