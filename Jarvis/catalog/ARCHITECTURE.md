...
335 modules in 33 packages, 181 JSON API routes, 35 UI modules, 132 test files; capabilities in CAPABILITIES.yaml.
...
- **gateway** — The ZEUS model gateway: one boundary between ZEUS and every model provider. (18 modules, 6300 lines)
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (43 modules, 25410 lines)
