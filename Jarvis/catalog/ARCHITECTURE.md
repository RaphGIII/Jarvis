...
327 modules in 33 packages, 171 JSON API routes, 31 UI modules, 116 test files; capabilities in CAPABILITIES.yaml.
...
- **capabilities** — the capability registry, resolver, acquisition and health (20 modules, 5990 lines)
...
- **experts** — Optional stronger intelligence, recruited on Jarvis' terms. (8 modules, 2140 lines)
- **gateway** — The ZEUS model gateway: one boundary between ZEUS and every model provider. (15 modules, 3356 lines)
...
- **owner** — The owner's domain: what ZEUS is, how it behaves, what it may spend. (4 modules, 838 lines)
- **persona** — persona profiles and language (4 modules, 519 lines)
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (41 modules, 23973 lines)
...
- **zeus_supervisor** — The ZEUS supervisor: the small process that is *not* ZEUS. (13 modules, 2947 lines)
...
- `tools/registry.py` ← 8 modules
- `core/identity.py` ← 7 modules
