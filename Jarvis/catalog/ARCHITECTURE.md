...
322 modules in 33 packages, 168 JSON API routes, 31 UI modules, 112 test files; capabilities in CAPABILITIES.yaml.
...
- **capabilities** — the capability registry, resolver, acquisition and health (16 modules, 4247 lines)
...
- `brain/json_utils.py` ← 14 modules
