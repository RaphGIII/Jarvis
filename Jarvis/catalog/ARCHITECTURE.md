...
330 modules in 33 packages, 171 JSON API routes, 33 UI modules, 124 test files; capabilities in CAPABILITIES.yaml.
...
- **core** — composition root (kernel) and identity (3 modules, 556 lines)
...
- **gateway** — The ZEUS model gateway: one boundary between ZEUS and every model provider. (16 modules, 5038 lines)
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (43 modules, 24922 lines)
