...
- **jarvis** — JARVIS command entry points. (13 modules, 2862 lines)
...
- **service** — the product service: core, HTTP API, intents, routing, self-development, isolation (43 modules, 25312 lines)
