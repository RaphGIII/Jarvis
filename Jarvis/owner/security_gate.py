...
SCOPES = ("PERSONALITY_EDIT", "SECURITY_CONFIG", "SELFDEV_PROMOTE", "INSTALL", "FILESYSTEM_DESTRUCTIVE",
          "PROJECT_DELETE", "CREDENTIALS", "SYSTEM_INTEGRATION", "AUTH_ADMIN", "PROTECTED_MEMORY")
...
SCOPE_LEVELS = {
    ...
    "FILESYSTEM_DESTRUCTIVE": 2, "PROJECT_DELETE": 2, "SYSTEM_INTEGRATION": 2, "PROTECTED_MEMORY": 2,
